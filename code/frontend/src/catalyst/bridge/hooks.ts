...
export function useCatalystLayout() {
  return {
    ...
    demoState: useLayoutStore((s) => s.demoState),
    demoMaterialAnimation: useLayoutStore((s) => s.demoMaterialAnimation),
    demoDnaAnimation: useLayoutStore((s) => s.demoDnaAnimation),
    applyDemoAction: useLayoutStore((s) => s.applyDemoAction),
    resetDemo: useLayoutStore((s) => s.resetDemo),

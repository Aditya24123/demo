  ...
  applyUiActions: async (actions) => {
    ...
    await applyUiActions(actions as Array<Record<string, unknown>>, {
      layout: {
        ...
        setGenomicsCaseId: layout.setGenomicsCaseId,
        setGenomicsVariantIndex: layout.setGenomicsVariantIndex,
        setGenomicsRepeatCount: layout.setGenomicsRepeatCount,
        resetGenomicsCamera: layout.resetGenomicsCamera,
        setGenomeSelection: layout.setGenomeSelection,
        setGenomeViewport: layout.setGenomeViewport,
        setGenomeSequenceVisible: layout.setGenomeSequenceVisible,
        applyDemoAction: layout.applyDemoAction,
